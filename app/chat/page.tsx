...
export default function ChatRedirect() {
  ...
  useEffect(() => {
    ...
    try {
      ...
      const message =
        ...
        "*Instructions:* " + (formData.specialInstructions || "None") + "%0a" +
        "*Total:* AED " + total

      const adminNumber = "971525076196"
      const clientNumber = formData.phone.replace(/\D/g, "")

      setAdminUrl("https://wa.me/" + adminNumber + "?text=" + message)
      setClientUrl("https://wa.me/" + clientNumber + "?text=" + message)
  ...
  if (!adminUrl || !clientUrl) return <div className="p-8">Preparing WhatsApp message...</div>
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center gap-6 text-center p-4">
      ...
      <p className="text-gray-600">Click below to send the message via WhatsApp</p>
